...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/XS1veGb8AT)
...
```sh
npx nx serve sherie-portfolio
```

To create a production bundle:

```sh
npx nx build sherie-portfolio
```

To see all available targets to run for a project, run:

```sh
npx nx show project sherie-portfolio
```
